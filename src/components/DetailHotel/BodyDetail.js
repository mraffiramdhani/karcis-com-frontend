        ...
        return (
            ...
            <Item style={{ backgrounColor: '#fff', marginTop: 30, marginLeft: 15, marginRight: 15, flexDirection: 'column' }}>
                <View style={{alignSelf: 'flex-start'}}>
                    <Text style={{fontSize: 17}}>OYO 1144 Aquina House</Text>
                </View>
            ...
            <View style={{marginTop: 30, marginLeft: 15, marginRight: 15, flexDirection: 'column' }}>
                <View style={{alignSelf: 'flex-start', marginBottom: 10}}>
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <View style={{marginLeft: 5, width: '17%', marginRight: 25}}>
                      ...
                      <Text style={{alignSelf: 'center', marginTop: 5}}>AC</Text>
                    </View>                   
                  </View>
              ...
              <View style={{ marginLeft: 15, marginRight: 15, flexDirection: 'column' }}> 
                  ...
                  <View style={{flexDirection: 'row'}}>
                                <YourIcon name="location" style={{ marginLeft: 10, marginTop: 10, fontSize: 25, fontWeight: 'bold'}} />
                                <Text style={{ marginTop: 10, fontSize: 15}}> OYO 1144 Aquina House </Text> 
                            </View>
                            <View>
                                <Text style={{ marginLeft: 35, fontSize: 13, color: '#48443B', marginBottom: 10}}>
                                  Jl. Perum Taman Pajajaran Blok B5 No.10, Katulampa, Kec. Bogor Timur, Kota Bogor </Text>
                            </View>
                  </Card>
                  ...
                  <View style={{alignSelf: 'flex-start', marginBottom: 10, marginTop: 10}}>
                      <Text style={{fontSize: 13, color: 'grey'}}>OYO 1144 Aquina House merupakan hotel bintang 2</Text>
                  </View>
                  ...
                  <Modal
                      ...
                      >
                      <ModalContent>                        
                          <Text>OYO 1144 Aquina House merupakan hotel bintang 2 yang ada di bogor</Text>
                          <Text style = {{marginTop: 10}}>Lorem ipsum dolor sit amet, 
